...
let jhon = new Person("jhon doe", 20)
...
// console.log(miniCalc.add(2,3));//// it can't access the method 


///// to use it the class directly call this
